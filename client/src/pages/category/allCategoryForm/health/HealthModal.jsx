...
const HealthModal = ({ single, handleSingleHide,  }) => {
   
    const { singleHealth } = useSelector(state => state.health);
                ...
                <div className="single-product">
                    <div className="row">
                        <div className="col-md-6">
                            <img src={`/image/healths/${singleHealth.photo}`} alt="" />
                        </div>
                        <div className="col-md-6">
                            <div className="single my-5">
                                <h2>{singleHealth.name}</h2>
                                <h3>Sale price : $ {singleHealth.slugName} </h3>
                                <h3>Regular price : $ <del>{singleHealth.status}</del> </h3>
